    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUserRoles_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Content2Categories", x => new { x.ContentId, x.CategoryId });
                    table.ForeignKey(
                        name: "FK_Content2Categories_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Content2Categories_Contents_ContentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuMembers_Categories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuMembers_Menus_MenuId",
                        column: x => x.MenuId,
                        principalTable: "Menus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MenuMembers_Pages_PageId",
                        column: x => x.PageId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Content2Tags", x => new { x.ContentId, x.TagId });
                    table.ForeignKey(
                        name: "FK_Content2Tags_Contents_ContentId",
                        column: x => x.ContentId,
                        principalTable: "Contents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Content2Tags_Tags_TagId",
                        column: x => x.TagId,
                        principalTable: "Tags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUserRoles_ManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Content2Categories_CategoryId",
                table: "Content2Categories",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_Content2Tags_TagId",
                table: "Content2Tags",
                column: "TagId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuMembers_CategoryId",
                table: "MenuMembers",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuMembers_MenuId",
                table: "MenuMembers",
                column: "MenuId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuMembers_PageId",
                table: "MenuMembers",
                column: "PageId");

            migrationBuilder.CreateIndex(
                name: "IX_Menus_Keyword_Language",
                table: "Menus",
